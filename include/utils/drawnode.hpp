...
namespace nwo5::utils {
    ...
    public:
        ...
        void createSegment(cocos2d::CCPoint pStart, cocos2d::CCPoint pEnd, float pThickness, const cocos2d::ccColor4F& pColor);
        ...
        void createLine(cocos2d::CCPoint pStart, cocos2d::CCPoint pEnd, float pThickness, const cocos2d::ccColor4F& pColor);
        ...
        void createDashedLine(cocos2d::CCPoint pStart, cocos2d::CCPoint pEnd, float pThickness, const cocos2d::ccColor4F& pColor, float pSegmentLength, float pSegmentDotSize = 0.5f);
        ...
        void createSegments(const cocos2d::CCPoint* pPoints, unsigned int pSize, float pThickness, const cocos2d::ccColor4F& pColor);
        /// draw a line from pPoints[0] to pPoints[1], then pPoints[1] to pPoints[2], etc...
        /// @note does nothing if segments < 2
        void createSegments(std::span<const cocos2d::CCPoint> pPoints, float pThickness, const cocos2d::ccColor4F& pColor);
        ...
        void createCircle(cocos2d::CCPoint pCenter, float pRadius, const cocos2d::ccColor4F& pColor, unsigned int pSegments, float pOutlineThickness = 0.0f, const cocos2d::ccColor4F& pOutlineColor = CLEAR_COLOR);
        /// draw an ellipse at pCenter with radius pRadius
        /// @param pSegments how many triangle "slices" the circle is made up of
        /// @note does nothing if segments < 3
        void createEllipse(cocos2d::CCPoint pCenter, cocos2d::CCSize pRadius, const cocos2d::ccColor4F& pColor, unsigned int pSegments, float pOutlineThickness = 0.0f, const cocos2d::ccColor4F& pOutlineColor = CLEAR_COLOR);
        ...
        void createPolygon(const cocos2d::CCPoint* pPoints, unsigned int pSize, const cocos2d::ccColor4F& pColor, float pOutlineThickness = 0.0f, const cocos2d::ccColor4F& pOutlineColor = CLEAR_COLOR);
        /// draw a polygon with points pPoints
        /// @note does nothing if segments < 3
        /// @note calls ccdrawnode::drawPolygon internally
        void createPolygon(std::span<const cocos2d::CCPoint> pPoints, const cocos2d::ccColor4F& pColor, float pOutlineThickness = 0.0f, const cocos2d::ccColor4F& pOutlineColor = CLEAR_COLOR);

        /// draw a square with radius pRadius
        void createDot(cocos2d::CCPoint pCenter, float pRadius, const cocos2d::ccColor4F& pColor);

        /// draw a rect from pRect
        void createRect(cocos2d::CCRect pRect, const cocos2d::ccColor4F& pColor, float pOutlineThickness = 0.0f, const cocos2d::ccColor4F& = CLEAR_COLOR);
        /// draw a rect from pStart to pEnd
        void createRect(cocos2d::CCPoint pStart, cocos2d::CCPoint pEnd, const cocos2d::ccColor4F& pColor, float pOutlineThickness = 0.0f, const cocos2d::ccColor4F& = CLEAR_COLOR);
